...
class SymbolTradingManager {
    ...
    async monitorSimpleProfitTarget(targetPercent = null) {
        try {
            ...
            // Initialize trailing stop on first run
            if (!this.entryPrice) {
            ...
            if (direction === "long") {
                ...
                // Handle trailing stop activation and updates for long positions
            ...
            // Update position status display if price has changed
            if (this.lastCheckedPrice !== currentPrice) {
                ...
                // Helper function for direction indicator
            ...
            // Handle trailing stop hits with confirmation threshold
            if (trailingStopHit) {
